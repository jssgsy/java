package com.univ.algorithom.stack.univstack;
...
public class UnivArrayStack {
	...
	public UnivArrayStack(){
		
	}
	
	public UnivArrayStack(int capacity){
		if (capacity < 0 ) {
	...
	public static void main(String[] args) {
		UnivArrayStack s = new UnivArrayStack(0);
		s.push("aa");
		s.push("ee");
		s.push("dd");
		s.push("aad");
